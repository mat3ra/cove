 ...
 */
export declare function resolveSelectedOption<T extends IdentifiedOption>(options: T[], selectedOptionId: string | null): T | undefined;
/** Whether a remembered id is worth restoring — i.e. it still names an option. */
export declare function isRestorableOptionId(options: IdentifiedOption[], savedOptionId: string | null): boolean;
